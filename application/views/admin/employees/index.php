        ...
        <div class="modal-dialog modal-lg" role="document"><div class="modal-content">
            <form method="post" action="<?= site_url('admin/employees/save') ?>" id="formTambahKaryawan">
                ...
                <div class="modal-body"><div class="form-row">
                    ...
                    <div class="form-group col-md-6"><label>Jenis Kelamin</label><select name="gender" class="form-control"><option value="">- Pilih -</option><option value="M">Laki-laki</option><option value="F">Perempuan</option></select></div>
    ...
    <script>
        $('#formTambahKaryawan').on('submit', function (event) {
            ...
            $.ajax({
                ...
                Swal.fire({ icon: 'error', title: 'Gagal', text: response.message || 'Karyawan gagal ditambahkan.' });
            }).fail(function (xhr) {
