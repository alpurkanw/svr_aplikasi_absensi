                ...
                <div class="container-fluid p-2">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body p-3">
                            <form id="formPerumDetail" action="<?= base_url('admin/Claporan/lap_out_per_perumahan_detail'); ?>" method="post">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover" id="lap_out_per_perumahan_table">
                                    ...
                                    <tbody>
                                        ...
                                        <?php else : ?>
                                            <tr>
                                                <td colspan="3" class="text-center text-muted">Tidak ada data pengeluaran per perumahan.</td>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
    ...
    <script>
        $(document).ready(function() {
            $('#lap_out_per_perumahan_table tbody').on('click', 'tr.clickable-row', function() {
                var idPerum = $(this).data('idPerum');
                if (!idPerum) {
                    idPerum = $(this).data('id-perum');
                }
                if (idPerum) {
