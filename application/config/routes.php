...
$route['api/v1/fingerprint-templates'] = 'api/fingerprint_templates/index';
$route['api/v1/fingerprint-templates/save'] = 'api/fingerprint_templates/save';
...
$route['admin/employees/detail-page/(:num)'] = 'admin/employees/detail_page/$1';
...
$route['admin/payroll'] = 'admin/payroll/index';
$route['admin/payroll/process'] = 'admin/payroll/process';
$route['admin/payroll/finalize'] = 'admin/payroll/finalize';
$route['admin/payroll-reports/summary'] = 'admin/payroll_reports/summary';
$route['admin/payroll-reports/issues'] = 'admin/payroll_reports/issues';
$route['admin/payroll-reports/deductions'] = 'admin/payroll_reports/deductions';
$route['admin/payslips'] = 'admin/payslips/view';
$route['admin/payslips/input'] = 'admin/payslips/input';
$route['admin/payslips/generate'] = 'admin/payslips/generate';
$route['admin/payslips/view'] = 'admin/payslips/view';
$route['admin/payslips/detail/(:num)'] = 'admin/payslips/detail/$1';
$route['admin/payslips/print/(:num)'] = 'admin/payslips/print_slip/$1';
...
$route['admin/client-credentials'] = 'admin/client_credentials/index';
$route['admin/client-credentials/save'] = 'admin/client_credentials/save';
$route['admin/client-credentials/generate'] = 'admin/client_credentials/generate';
$route['admin/app-config'] = 'admin/app_config/index';
$route['admin/app-config/save'] = 'admin/app_config/save';
$route['api/v1/client-config'] = 'api/client_config/index';
